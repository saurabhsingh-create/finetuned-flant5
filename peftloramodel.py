...
from config import lora_config, model_name, huggingface_dataset_name, output_dir, peft_model_path
...
def load_model_tokenizer_dataset():
...
def main():
    original_model, tokenizer, dataset = load_model_tokenizer_dataset()
